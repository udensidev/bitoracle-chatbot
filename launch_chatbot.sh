...
# Print header
echo "🚀 Launching BitOracle Chatbot 🚀"
echo "--------------------------------------------"
...
echo "⚙️ Starting the chatbot app in the background..."
python3 app.py &

# Give Gradio server a few seconds to start
sleep 5
...
if command -v xdg-open > /dev/null; then
    ...
    echo "👉 Please manually open http://127.0.0.1:7860 in your browser."
fi


# Goodbye message
echo "--------------------------------------------"
echo "✅ BitOracle Chatbot closed successfully."
